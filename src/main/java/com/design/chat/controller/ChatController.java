...
public class ChatController {
  ...
  public SseEmitter stream(
    @RequestParam @NotBlank(message = "message 必须是非空字符串") @Size(max = 4000, message = "message 长度不能超过 4000") String message,
    @RequestParam @NotBlank(message = "sessionId 必须是非空字符串") @Size(max = 64, message = "sessionId 长度不能超过 64") String sessionId
  ) {
